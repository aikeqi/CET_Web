...
<div class="container">
  <div class="register-form">
    <form class="form-horizontal" role="form" action="takeregister.jsp" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input class="form-control" type="password" placeholder="输入密码" required="" name="password1" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-3 control-label" for="repasswrod">重复密码</label>
        <div class="col-sm-8">
          <input class="form-control" type="password" placeholder="再次输入密码" required="" name="password2" />
        </div>
      </div>
      <div class="form-group">
